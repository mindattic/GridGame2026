...
$startTime = Get-Date
Write-Host "Starting Unity .cs export..." -ForegroundColor Cyan
...
'== GRIDGAME EXPORT =='               | Set-Content -LiteralPath $out -Encoding UTF8
'VERSION: 4'                          | Add-Content -LiteralPath $out -Encoding UTF8
