...
/// ```
///
/// Layout mirrors AbilitiesBuilder: the user can hop between Abilities and Equip
/// without re-learning the visual conventions.
///
/// RELATED FILES: EquipManager.cs, AbilitiesBuilder.cs
/// </summary>
public static class EquipBuilder
{
    ...
    public static void Build()
    {
        ...
        var mgrGO = SceneBuilderHelper.EnsureEmptyGameObject("EquipManagerGO", ref created, ref found);
        SceneBuilderHelper.EnsureScript<EquipManager>(mgrGO);
    ...
    {
        var invList = UiKit.ScrollList(body, "InventoryList");
        invList.anchorMin = new Vector2(0f, 0f);
        invList.anchorMax = new Vector2(1f, 0.55f);
        invList.offsetMin = new Vector2(0f, 0f);
        invList.offsetMax = new Vector2(0f, -8f);
        created++;
    }
