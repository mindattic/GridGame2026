...
/// <summary>
/// CREDITSSCAFFOLD - Editor tool to builder the Credits scene.
///
...
public static class CreditsBuilder
{
    ...
    public static void Build()
    {
        ...
        var mgr = SceneBuilderHelper.EnsureEmptyGameObject("CreditsManager", ref created, ref found);
        SceneBuilderHelper.EnsureScript<CreditsManager>(mgr);
        ...
        if (canvas != null)
        {
            ...
            if (sv != null)
            {
                ...
                if (viewport != null)
                {
                    ...
                    if (content != null)
                    {
                        var textarea = SceneBuilderHelper.EnsureLabel(
                        ...
                        if (textarea != null)
                        {
                            ...
                            if (textTMP != null)
                            {
                                textTMP.font = SceneBuilderHelper.LoadFont(SceneBuilderHelper.FontPaths.Consolas);
                                textTMP.fontSize = 36;
            ...
            if (backBtn != null && creditsManager != null)
                SceneBuilderHelper.WireOnClick(backBtn, new UnityAction(creditsManager.OnBackButtonClicked));
