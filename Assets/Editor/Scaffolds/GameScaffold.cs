// =============================================================================
// AUTO-GENERATED by SceneScaffoldGenerator from Game.unity
// Generated: 2026-04-20 18:36:57
//
...
public static class GameScaffold
{
    ...
    public static void Load()
    {
        if (!EditorUtility.DisplayDialog("Load",
            "Clear the Game scene and recreate all GameObjects from the scaffold?\n\n" +
    ...
    public static void CreateScaffolding()
    {
        ...
        img_PauseButton.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Pause);
        ...
        tmp_Label5.font = SceneScaffoldHelper.LoadFont(Font_LiberationSans_SDF);
        ...
        tmp_Front.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        tmp_Back3.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_Image3.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Transparent32x32);
        ...
        img_Image2.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Transparent32x32);
        ...
        tmp_Front3.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        tmp_Back5.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        tmp_Back.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_Image.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Transparent32x32);
        ...
        tmp_Front2.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_AbilityButtonContainer.sprite = SceneScaffoldHelper.LoadSprite(Sprite_action_bar_1);
        ...
        img_ArrowRight.sprite = SceneScaffoldHelper.LoadSprite(Sprite_ArrowRight);
        ...
        tmp_Text_TMP2.font = SceneScaffoldHelper.LoadFont(Font_LiberationSans_SDF);
        ...
        img_Backdrop.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Back_1024x256);
        ...
        tmp_Details.font = SceneScaffoldHelper.LoadFont(Font_Avenir);
        ...
        img_ArrowLeft.sprite = SceneScaffoldHelper.LoadSprite(Sprite_ArrowLeft);
        ...
        tmp_Text_TMP.font = SceneScaffoldHelper.LoadFont(Font_LiberationSans_SDF);
        ...
        img_Portrait.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Mannequin);
        ...
        img_AbilityCastConfirm.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Back_512x128);
        ...
        img_CancelButton.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Cancel);
        ...
        tmp_Label3.font = SceneScaffoldHelper.LoadFont(Font_Avenir);
        tmp_Label3.text = "X";
        ...
        img_CastButton.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Confirm);
        ...
        tmp_Label6.font = SceneScaffoldHelper.LoadFont(Font_Avenir);
        tmp_Label6.text = "Ok";
        ...
        tmp_Label4.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        // --- AbilityBar ---
        var go_AbilityBar = new GameObject("AbilityBar");
        go_AbilityBar.layer = 5;
        var rt_AbilityBar = go_AbilityBar.AddComponent<RectTransform>();
        rt_AbilityBar.SetParent(go_Canvas.GetComponent<RectTransform>(), false);
        rt_AbilityBar.anchorMin = new Vector2(0.5f, 0.5f);
        rt_AbilityBar.anchorMax = new Vector2(0.5f, 0.5f);
        rt_AbilityBar.pivot = new Vector2(0.5f, 0.5f);
        rt_AbilityBar.sizeDelta = new Vector2(512f, 96f);
        rt_AbilityBar.anchoredPosition = new Vector2(0f, 703f);
        go_AbilityBar.AddComponent<CanvasRenderer>();
        var img_AbilityBar = go_AbilityBar.AddComponent<Image>();
        img_AbilityBar.sprite = SceneScaffoldHelper.LoadSprite(Sprite_TitleBar);
        img_AbilityBar.color = new Color(1f, 1f, 1f, 1f);
        img_AbilityBar.raycastTarget = true;
        go_AbilityBar.AddComponent<Scripts.Canvas.AbilityBar>();
        var canvasGroup_AbilityBar = go_AbilityBar.AddComponent<CanvasGroup>();
        Undo.RegisterCreatedObjectUndo(go_AbilityBar, "Create AbilityBar");

        // --- Label ---
        var go_Label = new GameObject("Label");
        go_Label.layer = 5;
        var rt_Label = go_Label.AddComponent<RectTransform>();
        rt_Label.SetParent(go_AbilityBar.GetComponent<RectTransform>(), false);
        ...
        tmp_Label.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        tmp_Label.text = "Test";
        ...
        img_Back2.sprite = SceneScaffoldHelper.LoadSprite(Sprite_action_bar_back_1);
        ...
        img_Back4.sprite = SceneScaffoldHelper.LoadSprite(Sprite_action_bar_back_1);
        ...
        tmp_Clock.font = SceneScaffoldHelper.LoadFont(Font_LiberationSans_SDF_Fallback);
        ...
        img_Glow.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Coin);
        ...
        tmp_Value.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_Icon.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Coin);
        ...
        img_Image4.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Button_Bottom);
        ...
        tmp_Label10.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_StageSelectButton.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Back_512x128);
        ...
        tmp_Label9.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_QuitButton.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Back_512x128);
        ...
        tmp_Label16.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_SettingsButton.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Back_512x128);
        ...
        tmp_Label13.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_ResumeButton.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Back_512x128);
        ...
        tmp_Label14.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_RunAwayButton.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Back_512x128);
        ...
        tmp_Label11.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_PartyManagerButton.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Back_512x128);
        ...
        tmp_Label12.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_RestartStageButton.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Back_512x128);
        ...
        tmp_Label15.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_CreateSaveGameButton.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Back_512x128);
        ...
        tmp_Label17.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_QuickSaveGameButton.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Back_512x128);
        ...
        tmp_Label8.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        tmp_Label7.font = SceneScaffoldHelper.LoadFont(Font_Attic);
        ...
        img_Image5.sprite = SceneScaffoldHelper.LoadSprite(Sprite_Button_Bottom);
