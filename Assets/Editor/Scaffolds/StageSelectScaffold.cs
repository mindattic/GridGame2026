...
/// RELATED FILES: StageSelectManager.cs, CampaignStages.cs, VendorNavBarScaffold.cs
/// </summary>
public static class StageSelectScaffold
{
    ...
    [MenuItem("Tools/Scenes/StageSelect/Load")]
    ...
    [MenuItem("Tools/Scenes/StageSelect/Clear Scene")]
    ...
    public static void CreateScaffolding()
    {
        ...
        var mgrGO = SceneScaffoldHelper.EnsureEmptyGameObject("StageSelectManagerGO", ref created, ref found);
        SceneScaffoldHelper.EnsureScript<StageSelectManager>(mgrGO);
