...
Shader "Shader Forge/NoiseAlphaBlend" {
    Properties {
        ...
        _X_Focus_copy_copy ("X_Focus_copy_copy", Float ) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _X_Focus_copy_copy;
            struct VertexInput {
...
////// Emissive:
                ...
                float node_8618 = (_X_Focus_copy_copy*node_9080.g);
