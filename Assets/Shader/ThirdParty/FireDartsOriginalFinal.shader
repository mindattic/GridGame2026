...
Shader "Sine VFX/FireDartsOriginalFinal" {
    Properties {
        ...
        _ScrollFocus ("Scroll Focus", Range(-4, 4)) = 0
...
////// Emissive:
                ...
                float2 node_4218 = float2(((i.uv0.r*_Tiling)+(node_7717.g*_ScrollFocus)+lerp( 0.0, i.vertexColor.b, _RandomOffsetU )),lerp( i.uv0.g, (i.uv0.g+i.vertexColor.g), _RandomOffsetV ));
                ...
                fixed4 finalRGBA = fixed4(finalColor,saturate((node_9218.g*i.vertexColor.a*_OpacityBoost*node_2081.b*_mask_var.r)));
