...
/// <summary>
/// Central lookup for items by Id. Populated from static data classes.
/// </summary>
public static class ItemLibrary
{
  ...
  Register(ItemData_Healing.ManaPotion);
   ...
   Register(ItemData_Equipment.LeatherArmor);
    ...
    /// <summary>
    /// Registers an item definition if not already present.
    /// </summary>
    ...
    /// <summary>
    /// Gets an item by Id or null if not found.
    /// </summary>
   ...
   if (string.IsNullOrEmpty(id)) return null;
    ...
    /// <summary>
    /// Enumerates all item definitions.
    /// </summary>
