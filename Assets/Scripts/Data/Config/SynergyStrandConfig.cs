...
{
    /// <summary>
    /// SYNERGYSTRANDCONFIG - Static tuning values for SynergyStrand rendering.
    /// <para>PURPOSE: Replaces the former [SerializeField] fields on SynergyStrand with
    /// compile-time constants. The synergy line visual was previously tuned by clicking
    /// the GameObject in the Editor; values now live in source control so changes are
    /// reviewable diffs instead of hidden prefab/.meta edits.</para>
    /// <para>USAGE: Referenced directly from SynergyStrand.Awake/Configure/Tick.</para>
    /// <para>RELATED FILES: SynergyStrand.cs, SynergyLineStrandConfig.cs, SynergySparkConfig.cs</para>
    /// </summary>
    public static class SynergyStrandConfig
    {
        // ── Core ─────────────────────────────────────────────────────────────
