namespace Scripts.Data.Config
{
    ...
    /// launches into). Keeping the value in code — not in EditorPrefs, not in a
    /// JSON file — means the choice is diffable, reviewable, and survives fresh
    /// clones without any editor-side setup.</para>
    /// <para>AUTHORING: Do NOT hand-edit. Run GridGame.Console.ps1 → Option 20
    ...
    {
        // START_SCENE_BEGIN — PS1 rewrites the single line below. Keep markers intact.
        public const string StartScene = "TitleScreen";
        // START_SCENE_END
    }
}
