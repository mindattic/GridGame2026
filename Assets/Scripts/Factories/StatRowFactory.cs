...
namespace Scripts.Factories
{
    ...
    public static class StatRowFactory
    {
        ...
        public static RectTransform Create(RectTransform parent, string statName, float yPos)
        {
            ...
            CreateTMPChild(rt, "Label", statName, new Vector2(0f, 0f), new Vector2(100f, 32f));
            CreateTMPChild(rt, "Value", "0", new Vector2(300f, 0f), new Vector2(100f, 32f));
            ...
            barRT.sizeDelta = new Vector2(200f, 32f);
            barRT.anchoredPosition = new Vector2(130.83f, 0f);
            barGO.AddComponent<CanvasRenderer>();

            CreateBarImage(barRT, "Back", Vector2.zero, new Vector2(200f, 2f), SpriteLibrary.Sprites.TryGetValue("HealthBarBack3", out var backSprite) ? backSprite : null);
            CreateBarImage(barRT, "Fill", Vector2.zero, new Vector2(200f, 32f), SpriteLibrary.Sprites.TryGetValue("HealthBar1", out var fillSprite) ? fillSprite : null);
            var front = CreateBarImage(barRT, "Front", new Vector2(0f, 16f), new Vector2(200f, 32f), null);
        ...
        private static RectTransform CreateBarImage(RectTransform parent, string name, Vector2 pos, Vector2 size, Sprite sprite)
        {
            var go = new GameObject(name);
            go.layer = LayerMask.NameToLayer("UI");
            var rt = go.AddComponent<RectTransform>();
