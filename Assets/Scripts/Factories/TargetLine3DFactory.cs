...
{
    /// <summary>
    /// TARGETLINE3DFACTORY - Creates the world-space FFXII-style targeting arc.
    /// <para>PURPOSE: Builds a world-space arc with two LineRenderer passes (core + glow halo)
    /// and a traveling bead. Renders on the "VFX" sorting layer — always beneath any
    /// ScreenSpaceOverlay Canvas UI (e.g. ManaPool, timeline bar).</para>
    /// <para>WHEN TO USE: Effects anchored to board geometry that should read as part of the
    /// game world. For targeting arcs that must visually dominate the UI, prefer TargetLine2DFactory.</para>
    ...
    /// ├── SortingGroup
    /// └── TargetLine3DInstance (behavior)
    /// </code>
    /// </para>
    /// <para>RELATED FILES: TargetLine3DInstance.cs, TargetLine2DFactory.cs, TargetLineManager.cs</para>
    /// </summary>
    public static class TargetLine3DFactory
    {
        /// <summary>Creates a new world-space targeting arc. Color applied at spawn via TargetLine3DInstance.SetColor.</summary>
        public static GameObject Create(Transform parent = null)
        {
            var root = new GameObject("TargetLine3D");
            ...
            // else leave null — TargetLine3DInstance will attempt to resolve at Awake.
            ...
            root.AddComponent<TargetLine3DInstance>();
        ...
        private static void ConfigureLineRenderer(LineRenderer lr, float width, float alpha, int orderOffset)
        {
            ...
            // White gradient — TargetLine3DInstance.SetColor tints at runtime by multiplying
